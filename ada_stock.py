...
while loop == 1 :
	...
	for idx in range(0, len(products)):
		...
		if (stock != pro_stock[idx]):
			...
			email_body_html += '<FONT COLOR=blue><b><a href=' + URL2 + '> ' + name + '</a>: </b></FONT>' +  str(pro_id) + ' currently has <FONT COLOR=RED><b>' + str(stock) + '</b></FONT> in stock. ' + 'Change: <FONT COLOR=RED><b>' + str(stockChange) + '</b></FONT> in past ' + str(checkTimer) + ' seconds<br><br>\n'
